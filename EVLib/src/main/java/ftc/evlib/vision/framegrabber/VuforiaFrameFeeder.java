 ...
 *
 * @see ftc.evlib.vision.framegrabber.GlobalFrameGrabber
...
//        VuforiaLocalizer.Parameters params = new VuforiaLocalizer.Parameters();
       ...
       // try {
        ...
        //} catch (VuforiaLocalizerImpl.F e) {
        //    return null;
       // }
    ...
    public VuforiaFrameFeeder(Parameters params, int widthRequest, int heightRequest) {
        this(params, widthRequest, heightRequest, ftc.evlib.vision.framegrabber.FrameGrabber.CameraOrientation.PORTRAIT_UP, false);
    }

    public VuforiaFrameFeeder(Parameters params, ftc.evlib.vision.framegrabber.FrameGrabber.CameraOrientation cameraOrientation, int widthRequest, int heightRequest) {
    ...
    public VuforiaFrameFeeder(Parameters params, boolean ignoreOrientationForDisplay, int heightRequest, int widthRequest) {
        this(params, widthRequest, heightRequest, ftc.evlib.vision.framegrabber.FrameGrabber.CameraOrientation.PORTRAIT_UP, ignoreOrientationForDisplay);
    }
...
//                    Log.i("ParticleFinder", "width: " + bitmap.getWidth());
//                    Log.i("ParticleFinder", "height: " + bitmap.getHeight());
