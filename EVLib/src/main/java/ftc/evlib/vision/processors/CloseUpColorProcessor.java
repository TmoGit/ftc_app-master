 ...
 */
public class CloseUpColorProcessor implements ftc.evlib.vision.processors.ImageProcessor<ftc.evlib.vision.processors.BeaconColorResult.BeaconColor> {
     ...
     */
    @Override
    public ftc.evlib.vision.processors.ImageProcessorResult<ftc.evlib.vision.processors.BeaconColorResult.BeaconColor> process(long startTime, Mat rgbaFrame, boolean saveImages) {
...
//        thresholdMax.add(new Scalar((300) / 2, 255, 255));
        ...
        ImageUtil.log2DArray(FileUtil.getLogsDir(), "", startTime, "closeUpColSum.csv", ImmutableList.of("column", "red", "green", "blue"), colSum1);
