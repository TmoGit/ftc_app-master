...
import ftc.evlib.vision.processors.RedBlueBeaconProcessor;
...
public class VuforiaBeaconColorProcessor implements ftc.evlib.vision.processors.ImageProcessor<ftc.evlib.vision.processors.BeaconColorResult> {
    private static final String TAG = "VuforiaBeaconColor";
    private final VuforiaFrameFeeder vuforia;
    private final ftc.evlib.vision.processors.RedBlueBeaconProcessor beaconProcessor = new RedBlueBeaconProcessor(50, 100); //(5, 25); //(15, 15); //(51, 76);
    private int resultsFound = 0;
    private final List<ftc.evlib.vision.processors.BeaconColorResult> results = new ArrayList<>();
    ...
    private ftc.evlib.vision.processors.BeaconName beaconName = ftc.evlib.vision.processors.BeaconName.WHEELS;
    ...
    public ftc.evlib.vision.processors.BeaconColorResult getAverageResult() {
        //TODO simplify VuforiaBeaconColorProcessor.getAverageResult()
        Map<ftc.evlib.vision.processors.BeaconColorResult.BeaconColor, Integer> leftColors = new HashMap<>();
        Map<ftc.evlib.vision.processors.BeaconColorResult.BeaconColor, Integer> rightColors = new HashMap<>();

        for (ftc.evlib.vision.processors.BeaconColorResult result : results) {
            ftc.evlib.vision.processors.BeaconColorResult.BeaconColor leftColor = result.getLeftColor();
            ftc.evlib.vision.processors.BeaconColorResult.BeaconColor rightColor = result.getRightColor();
            int num = 0;
        ...
        int leftMax = 0;
        ftc.evlib.vision.processors.BeaconColorResult.BeaconColor leftMaxColor = ftc.evlib.vision.processors.BeaconColorResult.BeaconColor.UNKNOWN;
        for (Map.Entry<ftc.evlib.vision.processors.BeaconColorResult.BeaconColor, Integer> entry : leftColors.entrySet()) {
            ftc.evlib.vision.processors.BeaconColorResult.BeaconColor color = entry.getKey();
        ...
        int rightMax = 0;
        ftc.evlib.vision.processors.BeaconColorResult.BeaconColor rightMaxColor = ftc.evlib.vision.processors.BeaconColorResult.BeaconColor.UNKNOWN;
        for (Map.Entry<ftc.evlib.vision.processors.BeaconColorResult.BeaconColor, Integer> entry : rightColors.entrySet()) {
            ftc.evlib.vision.processors.BeaconColorResult.BeaconColor color = entry.getKey();
            int quantity = entry.getValue();

            if (quantity > 0 && rightMax * 1.0 / quantity < 0.9) {
                rightMax = quantity;
                rightMaxColor = color;
            }
        }
        return new ftc.evlib.vision.processors.BeaconColorResult(leftMaxColor, rightMaxColor);
    }

    @Override
    public ftc.evlib.vision.processors.ImageProcessorResult<ftc.evlib.vision.processors.BeaconColorResult> process(long startTime, Mat rgbaFrame, boolean saveImages) {
...
//        Log.i(TAG, beacon.getName());
        ...
        if (pose == null) {
            return new ftc.evlib.vision.processors.ImageProcessorResult<>(startTime, rgbaFrame, new ftc.evlib.vision.processors.BeaconColorResult());
        }
