...
public class CircleMatch implements Comparable<CircleMatch> {
    private final ftc.evlib.vision.processors.Circle c1, c2;
    ...
    public CircleMatch(RotatedRect c1, RotatedRect c2, Size imageSize) {
        this(new ftc.evlib.vision.processors.Circle(c1), new ftc.evlib.vision.processors.Circle(c2), imageSize);
    }
     ...
     * @param imageSize the size of the image to scale the circle sizes
     */
    public CircleMatch(ftc.evlib.vision.processors.Circle c1, ftc.evlib.vision.processors.Circle c2, Size imageSize) {
        this.c1 = c1;
        this.c2 = c2;
...
//    area = (area1 + area2)/2;
    ...
    public ftc.evlib.vision.processors.Circle getC1() {
        return c1;
    }

    public ftc.evlib.vision.processors.Circle getC2() {
        return c2;
    }
