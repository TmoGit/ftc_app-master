 ...
 */
public class RedBlueBeaconProcessor implements ftc.evlib.vision.processors.ImageProcessor<ftc.evlib.vision.processors.BeaconColorResult> {
...
//        Arrays.fill(centerOfMass, Double.MIN_VALUE);
        ...
        ftc.evlib.vision.processors.BeaconColorResult.BeaconColor left = ftc.evlib.vision.processors.BeaconColorResult.BeaconColor.UNKNOWN;
        ftc.evlib.vision.processors.BeaconColorResult.BeaconColor right = ftc.evlib.vision.processors.BeaconColorResult.BeaconColor.UNKNOWN;
        ...
        if (centerOfMass[0] != Double.MIN_VALUE && centerOfMass[2] != Double.MIN_VALUE && Math.abs(difference) >= MIN_CM_DIFF) {
            ...
            if (difference > 0) {
                left = ftc.evlib.vision.processors.BeaconColorResult.BeaconColor.RED;
                right = ftc.evlib.vision.processors.BeaconColorResult.BeaconColor.BLUE;
            } else {
                left = ftc.evlib.vision.processors.BeaconColorResult.BeaconColor.BLUE;
                right = ftc.evlib.vision.processors.BeaconColorResult.BeaconColor.RED;
            }
        }
