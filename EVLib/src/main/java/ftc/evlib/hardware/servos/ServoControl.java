 ...
 *
 * @see Servo
 * @see ftc.evlib.hardware.servos.ServoName
 * @see ftc.evlib.hardware.servos.ServoCfg
 */
public class ServoControl {
     ...
     */
    public ServoControl(Servo servo, ftc.evlib.hardware.servos.ServoName name, Enum startPreset) {
        this.servo = servo;
        this.name = name;

        OptionsFile optionsFile = new OptionsFile(EVConverters.getInstance(), ftc.evlib.hardware.servos.ServoCfg.getServoFile(name));
