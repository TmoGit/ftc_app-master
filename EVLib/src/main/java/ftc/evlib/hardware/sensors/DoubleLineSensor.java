 ...
 * @see ftc.evlib.hardware.sensors.DigitalSensor
 */
public class DoubleLineSensor implements ftc.evlib.hardware.sensors.DigitalSensor {
    ...
    public DoubleLineSensor(ftc.evlib.hardware.sensors.AnalogSensor leftSensor, AnalogSensor rightSensor) {
