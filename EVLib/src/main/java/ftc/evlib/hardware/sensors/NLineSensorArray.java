 ...
 */
public class NLineSensorArray implements ftc.evlib.hardware.sensors.LineSensorArray {
    private final List<ftc.evlib.hardware.sensors.LineSensorArray> lineSensorArrays;
    ...
    public NLineSensorArray(List<ftc.evlib.hardware.sensors.LineSensorArray> lineSensorArrays) {
        this.lineSensorArrays = lineSensorArrays;
        int numSensors1 = 0;

        for (ftc.evlib.hardware.sensors.LineSensorArray lineSensorArray : lineSensorArrays) {
