 ...
 */
public class FilteredLineSensorArray implements ftc.evlib.hardware.sensors.LineSensorArray {
    private final ftc.evlib.hardware.sensors.LineSensorArray lineSensorArray;
    ...
    public FilteredLineSensorArray(ftc.evlib.hardware.sensors.LineSensorArray lineSensorArray) {
