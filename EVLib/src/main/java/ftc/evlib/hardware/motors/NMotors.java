...
public class NMotors {
     ...
     */
    private final List<? extends ftc.evlib.hardware.motors.Motor> motors;
     ...
     */
    public NMotors(List<? extends ftc.evlib.hardware.motors.Motor> motors, boolean useSpeedMode, Velocity maxRobotSpeed) {
