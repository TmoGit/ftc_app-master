...
//        return Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_PICTURES);
    ...
    public static File getConfigsDir(Class clazz) {
        File dir = new File(getConfigsDir(), clazz.getSimpleName());
        mkdirsOrThrowException(dir);
        return dir;
    }

    public static File getConfigsFile(Class clazz, String filename) {
        return new File(getConfigsDir(clazz), filename);
    }
